...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var baseUrl = 'http://165.22.215.178/api';

  // Fetch and display products
  var fetchProducts = function fetchProducts() {
    fetch("".concat(baseUrl, "/products")).then(function (response) {
  ...
  var fetchCart = function fetchCart() {
    fetch("".concat(baseUrl, "/cart")).then(function (response) {
      return response.json();
    }).then(function (cart) {
      ...
      if (cartDiv) {
        ...
        for (var _i = 0, _Object$entries = Object.entries(cart); _i < _Object$entries.length; _i++) {
          var _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2),
            productId = _Object$entries$_i[0],
            quantity = _Object$entries$_i[1];
          var cartItemDiv = document.createElement('div');
          cartItemDiv.classList.add('card', 'mb-3');
          cartItemDiv.innerHTML = "\n                            <div class=\"card-body\">\n                                <p class=\"card-text\">Product ID: ".concat(productId, " - Quantity: ").concat(quantity, "</p>\n                                <button class=\"btn btn-danger\" onclick=\"removeFromCart(").concat(productId, ")\">Remove from Cart</button>\n                            </div>\n                        ");
  ...
  var fetchOrders = function fetchOrders() {
    fetch("".concat(baseUrl, "/orders")).then(function (response) {
      return response.json();
      ...
      if (ordersDiv) {
        ...
        orders.forEach(function (order) {
          var items = Object.entries(order.items).map(function (_ref) {
            var _ref2 = _slicedToArray(_ref, 2),
              name = _ref2[0],
              quantity = _ref2[1];
            return "".concat(name, ": ").concat(quantity);
          }).join(', ');
          var orderDiv = document.createElement('div');
          orderDiv.classList.add('card', 'mb-3');
          orderDiv.innerHTML = "\n                            <div class=\"card-body\">\n                                <p class=\"card-text\">Order ID: ".concat(order.id, " - Items: ").concat(items, "</p>\n                            </div>\n                        ");
  ...
  window.removeFromCart = function (productId) {
    ...
    fetch("".concat(baseUrl, "/cart/remove"), {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkShopEase"] = self["webpackChunkShopEase"] || [];
